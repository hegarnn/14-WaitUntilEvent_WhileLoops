...
def print_an_integer_many_times():
    ...
    #   The testing code is already written for you (above).
    # -------------------------------------------------------------------------
    x = int(input("Another number please!! "))
    for _ in range(x):
        print (2 * x)
...
def input_it_all():
    ...
    #   The testing code is already written for you (above).
    # -------------------------------------------------------------------------
    x = float(input("Can I get a number? "))
    y = int(input("How often do you want to see that number?"))
    z = input("What is something important to you? ")
